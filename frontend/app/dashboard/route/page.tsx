    ...
    <div className="max-w-7xl mx-auto space-y-6 pb-12 font-sans">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
        ...
        <div className="lg:col-span-8 light-saas-card p-6 flex flex-col justify-between space-y-4">
          ...
          {/* Canvas */}
          <div className="relative w-full h-[360px] rounded-2xl bg-[#0c1524] border border-slate-700/60 overflow-hidden flex items-center justify-center select-none shadow-inner">
            <div
